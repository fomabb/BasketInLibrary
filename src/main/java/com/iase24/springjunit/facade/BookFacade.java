...
public class BookFacade {
    ...
    public BookResponse getAllBooks(int page, int size) {
        List<Product> products = bookService.getAll(PageRequest.of(page, size));
    ...
    public BookResponse getBooksByCategoryId(Long categoryId, Boolean parent, int page, int size
        ...
        List<Product> products = bookService.findBooksChildCategoryId(categoryId, parent, PageRequest.of(page, size));
